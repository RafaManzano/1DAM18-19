...
public class SwingConversor{
	...
	private static JLabel label = new JLabel("1 Euro en son en dolares: ");
	private static JLabel lb1euros = new JLabel("Euros: ");
	private static JLabel lb1dolares = new JLabel ("Dolares: ");
	...
	public static void cambiotexto(ActionEvent e) {
		if (e.getSource() == txteuro) {
			...
			sliderdolar.setValue(Math.round(Float.parseFloat(txteuro.getText())));
		}
		
		if(e.getSource() == txtdolar) {
			System.out.println("dentro");
			float icambio = Float.parseFloat(txtdolar.getText());
			icambio = 100 * icambio / Float.parseFloat(txtdolar.getText());
			icambio = icambio / 100;
			txtdolar.setText(String.valueOf(icambio));
		}
	}
